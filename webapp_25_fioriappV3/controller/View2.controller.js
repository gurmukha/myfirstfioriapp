sap.ui.define([
	...
	return Controller.extend("ibm.fin.ar.controller.View2", {
		...
		onApprove: function(){
			...
			//Use this so that asynchronous function can access to this object of the view.
			var that = this;
			MessageBox.confirm("Are you sure, you wanna me go for vacation?",{
				title: "Yo Yo Holiday",
				//bind this so that asynchronous event handler function can access to this objects.
